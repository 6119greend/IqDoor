...
public final class ThunderBoardModule_ProvideKeyFirebaseFactory implements Factory<String> {
  ...
  public ThunderBoardModule_ProvideKeyFirebaseFactory(ThunderBoardModule module) {  
    assert module != null;
    this.module = module;
  }
  ...
  @Override
  public String get() {  
    String provided = module.provideKeyFirebase();
    if (provided == null) {
  ...
  public static Factory<String> create(ThunderBoardModule module) {  
    return new ThunderBoardModule_ProvideKeyFirebaseFactory(module);
  }
}
